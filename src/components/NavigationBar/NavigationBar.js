...
import reactSimpleShopLogo from "../../logo.svg";
...
export default class NavigationBar extends Component {
  constructor(props) {
    ...
    this.state = JSON.parse(localStorage.getItem("reactSimpleShopDontGo"))||{ goingOut: false, modalShowed: false };
  }
            ...
            <div className="container-fluid text-center mt-3">
              <div className="row">
                <div className="col-md-12">
                  <img alt="Logo reactSimpleShop" src={reactSimpleShopLogo} />
                </div>
              </div>
              <div className="row">
                <div className="col">
